...
public class Deposit extends JFrame implements ActionListener{
    ...
    Deposit(String pin){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("ASimulationSystem/ATM4.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(ae.getSource() == b1)
            {
                ...
                JOptionPane.showMessageDialog(null,"Taka. "+a+" Deposited Succeessfully");
